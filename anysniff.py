# if free didnt make it
# it wasnt made right

import subprocess, colorama, requests, base64, os

os.system('@title AnySniff ^| AnyDesk IP Sniffer ^| by free && cls')
...
# banner
print(base64.b64decode(b'').decode() + "\nwaiting for connection...", end='')
